  ...
  try {
   ...
   var  pokemonEspecialDefense = `ESP-DEF:${response.data["stats"][4]["base_stat"]}`;
    ...
    switch (response.data["types"][0].type.name) {
      case 'fire':
        slot.querySelector(".card").style.background = "linear-gradient(to right, #FF4500, #FF8C00)";
        break;
      case 'water':
        slot.querySelector(".card").style.background = "linear-gradient(to left, #1E90FF, #00BFFF)";
        break;
      case 'grass':
        slot.querySelector(".card").style.background = "linear-gradient(to right, #228B22, #32CD32)";
        break;
      case 'electric':
        slot.querySelector(".card").style.background = "linear-gradient(to left, #FFD700, #FFFF00)";
        break;
      case 'psychic':
        slot.querySelector(".card").style.background = "linear-gradient(to right, #8A2BE2, #DA70D6)";
        break;
      case 'ice':
        slot.querySelector(".card").style.background = "linear-gradient(to left, #00CED1, #1E90FF)";
        break;
      case 'dragon':
        slot.querySelector(".card").style.background = "linear-gradient(to right, #8B0000, #A52A2A)";
        break;
      case 'dark':
        slot.querySelector(".card").style.background = "linear-gradient(to left, #2F4F4F, #696969)";
        break;
      case 'fairy':
        slot.querySelector(".card").style.background = "linear-gradient(to right, #FFB6C1, #FF69B4)";
        break;
      case 'normal':
        slot.querySelector(".card").style.background = "linear-gradient(to left, #A9A9A9, #808080)";
        break;
      case 'fighting':
        slot.querySelector(".card").style.background = "linear-gradient(to right, #8B4513, #D2691E)";
        break;
      case 'flying':
        slot.querySelector(".card").style.background = "linear-gradient(to left, #87CEEB, #B0E0E6)";
        break;
      case 'poison':
        slot.querySelector(".card").style.background = "linear-gradient(to right, #9400D3, #8A2BE2)";
        break;
      case 'ground':
        slot.querySelector(".card").style.background = "linear-gradient(to left, #DAA520, #CD853F)";
        break;
      case 'rock':
        slot.querySelector(".card").style.background = "linear-gradient(to right, #BDB76B, #F4A460)";
        break;
      case 'bug':
        slot.querySelector(".card").style.background = "linear-gradient(to left, #556B2F, #6B8E23)";
        break;
      case 'ghost':
        slot.querySelector(".card").style.background = "linear-gradient(to right, #4B0082, #483D8B)";
        break;
      case 'steel':
        slot.querySelector(".card").style.background = "linear-gradient(to left, #C0C0C0, #B0C4DE)";
        break;
      default:
        slot.querySelector(".card").style.background = "linear-gradient(to right, #FFFFFF, #F5F5F5)";
        break;
    }
