function gerarCards(): void {
  ...
  for (let i = 0; i < 6; i++) {
    ...
    <div class="card-header">
      ...
      <div class="card-props">Flame Pokémon.<p class="pokemonHeight"> Length 5' 7"</p>, <p  class="pokemonWeight">Weight:200 lbs</p></div>
      <div class="card-body">
  ...
  try {
   ...
   var  pokemonEspecialDefense = `ESP-DEF:${response.data["stats"][4]["base_stat"]}`;
    ...
    for (let slot of slots) {
      ...
      slot.querySelector('.pokemon-img')!.src = pokemonImg;
