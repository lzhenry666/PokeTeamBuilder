...
async function buscarPreEvolucao(pokemonName: string): Promise<PreEvolucaoResultado> {
  try {
    ...
    console.log(`🚀 ~ file: main.ts:137 ~ buscarPreEvolucao ~ evolutionChain_pre_name:`, evolutionChain_pre_name);
    ...
    console.log('evolutionChain_pre_name:', evolutionChain_pre_name);
console.log('prevEvolution_img:', prevEvolution_img);

    if (
      evolutionChain_pre_name === null ||
      evolutionChain_pre_name === undefined ||
      evolutionChain_pre_name === "" &&
      prevEvolution_img === null ||
      prevEvolution_img === undefined ||
      evolutionChain_pre_name === ""
    ) {
      console.log("Entrando no bloco para retornar egg.png");
