  ...
  try {
   ...
   var  pokemonEspecialDefense = `ESP-DEF:${response.data["stats"][4]["base_stat"]}`;
    ...
    switch (response.data["types"][0].type.name) {
      case 'fire':
        card.style.background = "linear-gradient(to right, #FF4500, #FF8C00)";
        break;
      case 'water':
        card.style.background = "linear-gradient(to left, #1E90FF, #00BFFF)";
        break;
      case 'grass':
        card.style.background = "linear-gradient(to right, #228B22, #32CD32)";
        break;
      case 'electric':
        card.style.background = "linear-gradient(to left, #FFD700, #FFFF00)";
        break;
      case 'psychic':
        card.style.background = "linear-gradient(to right, #8A2BE2, #DA70D6)";
        break;
      case 'ice':
        card.style.background = "linear-gradient(to left, #00CED1, #1E90FF)";
        break;
      case 'dragon':
        card.style.background = "linear-gradient(to right, #8B0000, #A52A2A)";
        break;
      case 'dark':
        card.style.background = "linear-gradient(to left, #2F4F4F, #696969)";
        break;
      case 'fairy':
        card.style.background = "linear-gradient(to right, #FFB6C1, #FF69B4)";
        break;
      case 'normal':
        card.style.background = "linear-gradient(to left, #A9A9A9, #808080)";
        break;
      case 'fighting':
        card.style.background = "linear-gradient(to right, #8B4513, #D2691E)";
        break;
      case 'flying':
        card.style.background = "linear-gradient(to left, #87CEEB, #B0E0E6)";
        break;
      case 'poison':
        card.style.background = "linear-gradient(to right, #9400D3, #8A2BE2)";
        break;
      case 'ground':
        card.style.background = "linear-gradient(to left, #DAA520, #CD853F)";
        break;
      case 'rock':
        card.style.background = "linear-gradient(to right, #BDB76B, #F4A460)";
        break;
      case 'bug':
        card.style.background = "linear-gradient(to left, #556B2F, #6B8E23)";
        break;
      case 'ghost':
        card.style.background = "linear-gradient(to right, #4B0082, #483D8B)";
        break;
      case 'steel':
        card.style.background = "linear-gradient(to left, #C0C0C0, #B0C4DE)";
        break;
      default:
        card.style.background = "linear-gradient(to right, #FFFFFF, #F5F5F5)";
        break;
    }
