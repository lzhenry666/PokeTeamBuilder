...
async function buscarPreEvolucao(pokemonName : string) {
    try {
      ...
      const evolutionChainUrl = pokemonData.data.evolves_from_species.name;
      console.log(`🚀 ~ file: main.ts:134 ~ buscarPreEvolucao ~ pokemonData:`, pokemonData);
      console.log(`🚀 ~ file: main.ts:134 ~ buscarPreEvolucao ~ evolutionChainUrl:`, evolutionChainUrl);
      ...
      // Agora, você pode percorrer a cadeia para encontrar a evolução anterior
      ...
      while (currentStage) {
        ...
        prevEvolution = currentStage.species.name;
