function gerarCards(): void {
  ...
  for (let i = 0; i < 6; i++) {
    ...
    <div class="card-header">
      ...
      <div class="title">
        <h2 class="pokename">Charizard</h2><p class="pokemonHp">HP 120HP</p>
      ...
      <div class="card-props"><p class="pokemonType">Flame Pokémon.</p><p class="pokemonHeight"> Length 5' 7"</p>, <p  class="pokemonWeight">Weight:200 lbs</p></div>
      <div class="card-body">
        <div class="power-container">
          <h3 class="power-stats"> Pokémon Power : Energy Burn </h3>
          <p class="power-content pokemonAttack">As often as you like during your turn (before your attack),you may turn all energy attached to Charizard into Energy for the rest of the turn. This power can't be used if Charizard is Asleep,Confused or Paralysed</p>
          <p class="power-content pokemonDefense">As often as you like during your turn (before your attack),you may turn all energy attached to Charizard into Energy for the rest of the turn. This power can't be used if Charizard is Asleep,Confused or Paralysed</p>
          <p class="power-content pokemonEspecialAttack">As often as you like during your turn (before your attack),you may turn all energy attached to Charizard into Energy for the rest of the turn. This power can't be used if Charizard is Asleep,Confused or Paralysed</p>
          <p class="power-content pokemonEspecialDefense">As often as you like during your turn (before your attack),you may turn all energy attached to Charizard into Energy for the rest of the turn. This power can't be used if Charizard is Asleep,Confused or Paralysed</p>
          <p class="power-content pokemonSpeed">As often as you like during your turn (before your attack),you may turn all energy attached to Charizard into Energy for the rest of the turn. This power can't be used if Charizard is Asleep,Confused or Paralysed</p>
